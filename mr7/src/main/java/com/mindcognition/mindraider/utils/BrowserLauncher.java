 ...
 * Cantatore, Larry Barowski, Trevor Bedzek, Frank Miedrich, and Ron Rabakukk<br>
 * Changed by a. shapiro to work with touchgraph wikibrowser and win 95, but
 * with hack to work on NT from christoph drieschner 2002/06/02!!!
 * 
...
public final class BrowserLauncher {
	 ...
	 * URLs containing spaces to work. Originally was set to "\"\"", but setting
	 * to "" mysteriously made things work on windows98 with IE5.5. Alex Shapiro
	 * (11/18/2001).<br>
	 * Depends on jvm: "\"\"" for NT (see case stmt)//christoph drieschner
	 * 2002/06/02.
	 */
	...
	/**
	 * The Netscape open parameter start.
	 */
	private static final String NETSCAPE_OPEN_PARAMETER_START = "'openURL(";

	/**
	 * The Netscape close paramenter start.
	 */
	...
	/**
	 * Preferred Linux browser (added by MindRaider).
	 */
	public static String preferredBrowserPath = "firefox";
	...
	/**
	 * Method required for Mac OS X to stop the browser ?.
	 * 
	 * @param instance
	 *            The array of instances.
	 * @return Returns integer.
	...
	/**
	 * Method required for Mac OS X to launch browser for opening a URL ?.
	 * 
	 * @param instance
	 *            The instance.
	 * @param hint
	 ...
	 *            The array of start selection.
	 * @param selectionEnd
	 *            The array of end selection.
	 * @return Returns integer.
	 */
	...
	public static void openURL(String url) throws IOException {
		...
		case WINDOWS_NT:
			logger
					.debug("Running on NT, using Christoph Drieschners Hack for Third_parameter, see BrowserLauncher.java");
