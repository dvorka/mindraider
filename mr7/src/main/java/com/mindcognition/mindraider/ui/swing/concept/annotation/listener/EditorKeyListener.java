...
public class EditorKeyListener implements KeyListener {
    ...
    public EditorKeyListener(ConceptJPanel conceptJPanel, AbstractTextAnnotationRenderer renderer) {
    ...
    public void keyPressed(KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyCode() == KeyEvent.VK_L && keyEvent.isControlDown()) {
            new NoteInterlinkingJDialog(renderer);
        }
        ...
        if (keyEvent.getKeyCode() == KeyEvent.VK_ESCAPE || keyEvent.getKeyCode() == KeyEvent.VK_E && keyEvent.isControlDown()) {
            // switch to view mode
            renderer.toViewMode();
        }
    }
