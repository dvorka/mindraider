...
public class HtmlAnnotationRenderer extends AbstractTextAnnotationRenderer {
    
    private static final Log logger = LogFactory.getLog(HtmlAnnotationRenderer.class); // {{debug}}
    
    /**
     * the label text constant.
     * TODO consider bundle
     */
    public static final String LABEL_TEXT = "HTML";

    public HtmlAnnotationRenderer() {
    }
    ...
    public String getAnnotationTypeOwlClass() {
        return MindRaiderConstants.MR_OWL_CONTENT_TYPE_HTML;
    }
    ...
    private static final long serialVersionUID = -3175478167179198528L;
}
