 ...
 */
public final class BlackAndBlueSpidersColorProfile implements SpidersColorProfile {
    ...
    public String getUri() {
        return MindRaiderConstants.MR_RDF_URN+":spiders:color-profiles:blackAndBlue";
    }
