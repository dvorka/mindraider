 ...
 */
public final class BlackAndGreenSpidersColorProfile implements SpidersColorProfile {
    ...
    public Color getObjectSelectBackColor() {
        return new Color(0xa3,0xbf,0x00);
    }
    ...
    public String getUri() {
        return MindRaiderConstants.MR_RDF_URN+":spiders:color-profiles:blackAndGreen";
    }
