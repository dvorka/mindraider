...
public class OpenOutlineJDialog extends ProgramIconJDialog {
    private static final Logger logger = Logger.getLogger(OpenOutlineJDialog.class);
     ...
     * Constructor.
     */
    public OpenOutlineJDialog() {
        this("Open Outline", " Select Outline to open: ", "Open", true);
    }
     ...
     */
    public OpenOutlineJDialog(String dialogTitle, String selectionLabel, String buttonLabel, boolean showCancel) {
    ...
    public OpenOutlineJDialog(String dialogTitle, String selectionLabel, String buttonLabel, boolean showCancel,
        ...
        notebookLabel.addKeyListener(new KeyListener() {
            ...
            public void keyPressed(KeyEvent keyEvent) {
                if (keyEvent.getKeyCode() == KeyEvent.VK_ENTER) {
                    ...
                    openNotebook(notebookLabel.getText());
                }
            }
        ...
        if (showCancel) {
            ...
            cancelButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    OpenOutlineJDialog.this.dispose();
                }
            });
        }
     ...
     * @param string 
     */
    protected void openNotebook(String name) {
        ...
        if (notebookToShowUri != null) {
            ...
            if (notebookToOpen != null) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(OpenOutlineJDialog.this, Messages
