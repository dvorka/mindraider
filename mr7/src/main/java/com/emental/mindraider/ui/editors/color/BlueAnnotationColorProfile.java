...
public class BlueAnnotationColorProfile implements AnnotationColorProfile {
    ...
    public String getUri() {
        return MindRaiderConstants.MR_RDF_URN+":annotation:color-profiles:blue";
    }
    ...
    public Color getBackroundColor() {
        return new Color(0x00,0x00,0x11);
    }
