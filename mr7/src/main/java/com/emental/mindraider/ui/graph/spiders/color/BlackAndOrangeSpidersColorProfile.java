 ...
 */
public final class BlackAndOrangeSpidersColorProfile implements SpidersColorProfile {
    ...
    public Color getObjectSelectBackColor() {
        return new Color(0xff,0x91,0x00);
    }
    ...
    public String getUri() {
        return MindRaiderConstants.MR_RDF_URN+":spiders:color-profiles:blackAndOrange";
    }
